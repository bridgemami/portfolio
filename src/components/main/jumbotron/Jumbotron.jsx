...
export default function Jumbotron (props) {
    return (
        <section className={`d-flex flex-wrap .justify-content-center justify-content-sm-around`}>
    ...
    <h1 className="text-center align-self-center align-items-center">{props.name}<br />{props.title}</h1>
